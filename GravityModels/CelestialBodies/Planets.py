...
class Earth:
    def __init__(self):
        ...
        self.EGM96 = pooch.retrieve(
            ...
            fname="EGM96_raw.zip",
            path=os.path.dirname(GravityModels.__file__) + "/Files/SH_coefficients/Earth/",
            processor=self.format_EGM96_sh
        )
        ...
        self.EGM2008 = pooch.retrieve(
            ...
            path=os.path.dirname(GravityModels.__file__) + "/Files/SH_coefficients/Earth/",
            processor=self.format_EGM2008_sh
        )
    ...
    def unpack(self, fname, action, member):
    ...
    def format_EGM96_sh(self, fname, action, pooch_inst):
        unzipped = self.unpack(fname, action, "EGM96")
    ...
    def format_EGM2008_sh(self, fname, action, pooch_inst):
        unzipped = self.unpack(fname, action, "EGM2008_to2190_TideFree")
        new_name = fname.split("_raw")[0] + ".txt"
        if os.path.exists(new_name):
            return new_name
...
class Moon:
    def __init__(self):
        ...
        self.GRGM1200 = pooch.retrieve(
            ...
            path=os.path.dirname(GravityModels.__file__) + "/Files/SH_coefficients/Moon/",
